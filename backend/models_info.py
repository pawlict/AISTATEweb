...
MODELS_GROUPS: Dict[str, List[str]] = {
    ...
    # === PROOFREADING / LANGUAGE CORRECTION (7) ===
    "proofreading": [
        "qwen3:8b",
        "qwen3:14b",
...
MODELS_INFO: Dict[str, Dict[str, Any]] = {
    ...
    "SpeakLeash/bielik-11b-v2.3-instruct:Q4_K_M": {
        "display_name": "Bielik 11B v2.3 Q4_K_M (Polski, 6.7 GB)",
        "category": "proofreading",
        "hardware": {
            "vram": "8GB",
            "min_gpu": "RTX 2060 6GB",
        ...
        "use_cases": [
            "REKOMENDOWANY — najlepszy balans jakość/rozmiar dla polskiego",
        ...
        "recommendation": "Najlepszy wybór na start. Kwantyzacja Q4_K_M (6.7 GB) — zmieści się na większości GPU 8 GB+. Minimalna strata jakości vs pełny model. Apache 2.0 — wolna licencja.",
        "defaults": {"proofreading": False},
        "capabilities": ["polish_native", "proofreading", "grammar_pl", "spelling_pl", "formal_pl"],
    },
    "SpeakLeash/bielik-11b-v2.3-instruct:Q5_K_M": {
        "display_name": "Bielik 11B v2.3 Q5_K_M (Polski, 7.9 GB)",
        "category": "proofreading",
        "hardware": {
            "vram": "9GB",
            "min_gpu": "RTX 3060 12GB",
        ...
        "use_cases": [
            "Lepsza jakość niż Q4 — mniej artefaktów kwantyzacji",
            "Korekta fleksji i deklinacji (przypadki, końcówki)",
            "Poprawa szyku zdań i stylistyki polskiej",
            "Korekta ortografii polskiej (ó/u, rz/ż, ch/h)",
            "Korekta tekstów urzędowych i formalnych PL",
        ...
        "recommendation": "Złoty środek — wyższa precyzja niż Q4_K_M przy umiarkowanym wzroście VRAM (7.9 GB). Dobry wybór gdy masz GPU 12 GB+. Apache 2.0.",
        "defaults": {"proofreading": False},
        "capabilities": ["polish_native", "proofreading", "grammar_pl", "spelling_pl", "formal_pl"],
    },
    "SpeakLeash/bielik-11b-v2.3-instruct:Q6_K": {
        "display_name": "Bielik 11B v2.3 Q6_K (Polski, 9.2 GB)",
        "category": "proofreading",
        "hardware": {
            "vram": "11GB",
            "min_gpu": "RTX 3060 12GB",
        ...
        "use_cases": [
            "Wysoka precyzja — bliska oryginałowi (FP16)",
            "Korekta fleksji i deklinacji (przypadki, końcówki)",
            "Poprawa szyku zdań i stylistyki polskiej",
            "Korekta ortografii polskiej (ó/u, rz/ż, ch/h)",
            "Korekta tekstów urzędowych i formalnych PL",
        ...
        "recommendation": "Jakość bliska oryginałowi. 9.2 GB — wymaga GPU 12 GB+. Dobry wybór gdy precyzja korekty jest priorytetem. Apache 2.0.",
        "defaults": {"proofreading": False},
        "capabilities": ["polish_native", "proofreading", "grammar_pl", "spelling_pl", "formal_pl"],
    },
    "SpeakLeash/bielik-11b-v2.3-instruct:Q8_0": {
        "display_name": "Bielik 11B v2.3 Q8_0 (Polski, 12 GB)",
        "category": "proofreading",
        "hardware": {
            "vram": "14GB",
            "min_gpu": "RTX 4060 Ti 16GB",
            "optimal_gpu": "RTX 4090 24GB",
            "ram": "32GB",
        },
        "performance": {
            "speed_tokens_sec": 18,
            "analysis_time": {
                "proofreading": "8-16 sekund (1000 słów)",
            },
            "quality_stars": 5,
            "polish_quality_stars": 5,
        },
        "use_cases": [
            "Najwyższa jakość — praktycznie identyczna z FP16",
            "Korekta fleksji i deklinacji (przypadki, końcówki)",
            "Poprawa szyku zdań i stylistyki polskiej",
            "Korekta ortografii polskiej (ó/u, rz/ż, ch/h)",
            "Korekta tekstów urzędowych i formalnych PL",
        ...
        "recommendation": "Maksymalna jakość (prawie FP16). 12 GB — wymaga GPU 16 GB+. Wolniejszy i cięższy. Użyj gdy jakość korekty jest absolutnym priorytetem. Apache 2.0.",
        "warning": "Duży model (12 GB). Wymaga GPU z min. 16 GB VRAM. Dla większości zastosowań Q4_K_M lub Q5_K_M wystarczą.",
        "defaults": {"proofreading": False},
        "capabilities": ["polish_native", "proofreading", "grammar_pl", "spelling_pl", "formal_pl"],
    },
    "PRIHLOP/PLLuM": {
