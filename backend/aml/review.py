...
def get_statement_header(statement_id: str) -> Dict[str, Any]:
    ...
    blocks = [
        ...
        {"field": "account_holder", "label": "Wlasciciel", "value": stmt_dict.get("account_holder", ""), "type": "text", "editable": True},
        ...
        {"field": "opening_balance", "label": "Saldo poczatkowe", "value": stmt_dict.get("opening_balance", ""), "type": "amount", "editable": True},
        {"field": "closing_balance", "label": "Saldo koncowe", "value": stmt_dict.get("closing_balance", ""), "type": "amount", "editable": True},
        {"field": "available_balance", "label": "Saldo dostepne", "value": stmt_dict.get("available_balance", ""), "type": "amount", "editable": True},
        {"field": "currency", "label": "Waluta", "value": stmt_dict.get("currency", "PLN"), "type": "text", "editable": True},
        {"field": "declared_credits_sum", "label": "Suma uznan", "value": stmt_dict.get("declared_credits_sum", ""), "type": "amount", "editable": True},
