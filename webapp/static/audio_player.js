...
(function () {
  ...
  AudioPlayer.prototype._render = function (container) {
    ...
    html += '<svg viewBox="0 0 24 24" width="18" height="18"><path d="M12.5 8V4l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11z" fill="currentColor" transform="scale(-1,1) translate(-24,0)"/></svg>';
    html += '</button>';
    ...
    html += '<svg class="ap-icon-pause" viewBox="0 0 24 24" width="22" height="22" style="display:none"><rect x="5" y="3" width="4" height="18" fill="currentColor"/><rect x="15" y="3" width="4" height="18" fill="currentColor"/></svg>';
    html += '</button>';

    // Skip forward
    html += '<button class="ap-btn" data-act="skip-fwd" title="' + _t("player.fwd5") + '">';
    html += '<svg viewBox="0 0 24 24" width="18" height="18"><path d="M12.5 8V4l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11z" fill="currentColor"/></svg>';
    html += '</button>';
